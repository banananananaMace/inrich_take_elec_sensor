...
{
    GpioSetIrq( RADIO_DIO_PORT, RADIO_DIO1_PIN, IRQ_HIGH_PRIORITY, irqHandlers[0] );
}
...
{
    return ( GpioRead( RADIO_DIO_PORT, RADIO_DIO1_PIN ) << 1 ) | ( GpioRead( RADIO_BUSY_PORT, RADIO_BUSY_PIN ) << 0 );
}
