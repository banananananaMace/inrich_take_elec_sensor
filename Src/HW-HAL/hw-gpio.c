...
void FrstGpioInit( void )//test
{
    ...
    HAL_GPIO_Init( LED_TX_PORT, &GPIO_InitStruct );
	  GpioWrite( LED_TX_PORT, LED_TX_PIN , GPIO_PIN_SET );
    ...
    GPIO_InitStruct.Pin =  V_BAT_PIN  | RADIO_nRESET_PIN  ;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void GpioDeInit( void )
{
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_APort;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init( GPIOA, &GPIO_InitStruct );

    GPIO_InitStruct.Pin = 0xFFF7;//GPIO_PIN_BPort;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init( GPIOB, &GPIO_InitStruct );
